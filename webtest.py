...
#                  Import Libraries            #
################################################
from wiringx86 import GPIOGalileo2 as GPIO
...
def action(changePin, action):
   ...
   if action == "on":
      # Set the pin high:
      gpio.digitalWrite(changePin, gpio.HIGH)
...
if __name__ == "__main__":
   app.run(host='169.254.6.252', port=8080, debug=False)
